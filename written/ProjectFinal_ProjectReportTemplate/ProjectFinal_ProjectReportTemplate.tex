...
\author{\emph{Team name}: Andrés Beck-Ruiz, Claire Oberg, Jed Fox.\\
Brown University\\
}
...
You will be asked to respond to a list of potential ethical concerns with your project. You will receive an email from the TAs with your group's list shortly after final project progress reports are due.
